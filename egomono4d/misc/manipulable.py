...
class Manipulable:
    ...
    def __getitem__(self: T, slices) -> T:
    ...
    @staticmethod
    def recursive_slice(value: Any, slices: Any) -> Any:
        if not is_sliceable(value):
            return  value
        ...
        can_recurse = is_sliceable(value[0])
    ...
    @staticmethod
    def cat(manipulables, dim: int) -> T:
    ...
    @staticmethod
    def cat_sliceable(values, dim: int):
        model = values[0]
