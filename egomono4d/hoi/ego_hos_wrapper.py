...
class EgoHOSWrapper:
    ...
    def __init__(self, 
                 cache_path,
                 repo_path='./cache/ego_hos_checkpoints',
                 ...
                 obj1_cfg='work_dirs/twohands_cb_to_obj1_ccda/twohands_cb_to_obj1_ccda.py',
                 ...
                 obj1_ckpt='work_dirs/twohands_cb_to_obj1_ccda/best_mIoU_iter_34000.pth',
                 device='cuda'
                 ):
        ...
        self.obj1_model = init_segmentor(self.obj1_cfg, self.obj1_ckpt, device=device)
    ...
    def segment(self, image_fp, vis=False, use_image=False):
        ...
        seg_obj1 = inference_segmentor(self.obj1_model, cache_fp)[0]
        ...
        if (vis is True):
            ...
            obj1_vis = visualize_twohands_obj1(img, seg_obj1)
            imsave("vis_obj1.png", obj1_vis.astype(np.uint8))

        # pdb.set_trace()

        return seg_hands, seg_obj1, seg_cb
